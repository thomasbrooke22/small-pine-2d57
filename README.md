...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "wandering-flower-4138-d1":

```bash
npx wrangler d1 create wandering-flower-4138-d1
```
